...
'''
Results:
- rna_seq_merged.csv: test file (currently using in R analysis)
- wgbs_merged.csv: test file (currently using in R analysis)
- rna_seq_merged.csv.gz: full merged RNA-seq data (use for final analysis)
- wgbs_merged.csv.gz: full merged WGBS data (use for final analysis)
'''
